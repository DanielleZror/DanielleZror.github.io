...
export default function ContactDetails() {
    return (
        <div className="flex gap-7 flex-wrap mt-auto max-lg:mt-14 max-sm:grid max-sm:grid-cols-2 max-sm:gap-0">
            <div className="flex gap-2 items-center max-sm:pb-6">
                <HiOutlinePhone size={22} color="#E9A5C5" />
                <h5>615-207-5367</h5>
            </div>
            <a className="flex gap-2 items-center max-sm:pb-6" href={`mailto:daniellezror@gmail.com`}>
            ...
            <a target="_blank" rel="noreferrer" className="flex gap-2 items-center max-sm:pb-6"
